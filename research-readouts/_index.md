# Research Readouts Index

Maintained by `research/scripts/build_index.py`. Flat table of files in `research-readouts/` — title, status, tags, source type, last updated, and any linked research findings.
