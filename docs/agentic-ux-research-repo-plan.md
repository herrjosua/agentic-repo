# Agentic UX Research Repo — Draft Plan
...
- **`AGENTS.md`** is what makes the "ping it in 6 months" step actually work — it tells any agent session, cold, how the repo is organized, what the frontmatter/tag schema means, and where to look first. See §4a for how this plays with Claude Code specifically, and with Copilot on the work side.
...
date: 2026-09-11
type: usability-test        # usability-test | interview | survey | analytics | synthesis
...
- Where does analytics/quant data (if any) fit — same repo as a `type: analytics` finding, or a separate source that findings link out to?
