...
source_type: native
persona_ref: "personas/dana-overwhelmed-new-admin.md"
scope: "Signup through first workspace created"
---

## Overview
Follows Dana from receiving the "set up Fernway" task through first
